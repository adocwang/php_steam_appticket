...
/**
 * This file is just a copy of GitHub: {@link https://github.com/xPaw/SteamID.php}
 * and namespace resetted
 *
 * @author xPaw
 * @license MIT
 */
...
class SteamID
{
     ...
     */
    public static function SetFromURL(string $Value, callable $VanityCallback)
    {
     ...
     * @return SteamID Fluent interface
     */
    public function SetAccountInstance(int $Value)
    {
     ...
     * @return \GMP
     */
    private function Get(int $BitOffset, $ValueMask)
    {
     ...
     * @return \GMP
     */
    private static function ShiftLeft($x, int $n)
    {
     ...
     * @return \GMP
     */
    private static function ShiftRight($x, int $n)
    {
